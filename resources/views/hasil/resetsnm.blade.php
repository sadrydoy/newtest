...
<li>
  ...
  <li>
      <a href="{{url('/#')}}">
          <i class="material-icons">layers</i>
          <span>Reset Import SNMPTN</span>
      </a>
  </li>
  <li>
      <a href="{{url('/datareset')}}">
          <i class="material-icons">layers</i>
          <span>Reset Data Hasil SNMPTN</span>
      </a>
  </li>
</ul>
</li>
                          ...
                          <div class="modal fade" id="konfirmasihapus{{$p->kode_tahun_akademik}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <form action="{{url('/snmptnimportreset')}}" method="post">
                                        @csrf
                                      <div class="modal-body">
                                          Mereset data akan mengulang import data SNMPTN dari awal seperti membuat tahun akademik, kriteria nilai lalu mengimport data snmptn.  Apakah anda yakin ?
                                      </div>
